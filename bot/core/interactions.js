...
const spartanRegistrationModalHandler = require('../handlers/spartanRegistrationModalHandler');
...
async function handle(interaction) {
  ...
  if (interaction.isModalSubmit() && interaction.customId === 'spartan_register_1') return spartanRegistrationModalHandler(interaction);
