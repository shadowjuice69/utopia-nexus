/**
 * Age 116 thievery data — Utopia War Room wiki is authoritative for this project.
 * This file contains age-specific values only; calculation logic remains in index.js.
 */
...
export const AGE_116_PERSONALITIES = Object.freeze({
  ...
  Heretic: entry('Heretic', {
    tpaMultiplier: 1.35,
    crimeScienceEffectivenessMultiplier: 1.25,
  ...
  Rogue: entry('Rogue', {
    ...
    crimeScienceEffectivenessMultiplier: 1.40,
    stealthRecoveryBonusPerTick: 1,
    allThieveryOperations: true,
    sabotageThiefLossMultiplier: 0.50,
  }),
  Sage: entry('Sage'),
  Tactician: entry('Tactician', { espionageThiefLossMultiplier: 0 }),
...
export const AGE_116_DRAGONS = Object.freeze({
  Amethyst: entry('Amethyst', { sabotageSuccessChanceMultiplier: 0.60, sabotageDamageTakenMultiplier: 1 }),
...
export const AGE_116_SCIENCE = Object.freeze({
  crimeMultiplier: 0.1557,
  shieldingMultiplier: 0.0350,
  cunningMultiplier: 0.0314,
  finesseMultiplier: 0.08685,
});

export const AGE_116_SPELLS = Object.freeze({
  Invisibility: Object.freeze({
    target: 'self',
    offensiveTpaMultiplier: 1.10,
    thiefLossMultiplier: 0.80,
  }),
  Guile: Object.freeze({
    target: 'self',
    sabotageDamageMultiplier: 1.10,
  }),
  'Illuminate Shadows': Object.freeze({
    target: 'target',
    thieveryDamageTakenMultiplier: 0.80,
  }),
  'Clear Sight': Object.freeze({
    target: 'self',
    catchChance: 0.25,
  }),
});
...
export const AGE_116_OPERATIONS = Object.freeze({
  ...
  destabilize_guilds: Object.freeze({ id: 'destabilize_guilds', name: 'Destabilize Guilds', category: 'sabotage', relations: 'all', rogueOnly: true, meterGain: 0, notes: ['Reduces enemy spell duration by 20%.'] }),
  ...
  rob_vaults: Object.freeze({ id: 'rob_vaults', name: 'Rob the Vaults', category: 'sabotage', relations: 'all', maxPercentNormal: 0.052, maxPercentWar: 0.14, gainsPerThiefNormal: 40, gainsPerThiefWar: 106, meterGain: 0.12 }),
  ...
  kidnapping: Object.freeze({ id: 'kidnapping', name: 'Kidnapping', category: 'sabotage', relations: 'all', maxPercentNormal: 0.0185, maxPercentWar: 0.04, gainsPerThiefNormal: 0.132, gainsPerThiefWar: 0.285, meterGain: 0.12 }),
  ...
  arson: Object.freeze({ id: 'arson', name: 'Arson', category: 'sabotage', relations: 'all', meterGain: 0.24, notes: ['Damage increased by 5% in Age 116.'] }),
  greater_arson: Object.freeze({ id: 'greater_arson', name: 'Greater Arson', category: 'sabotage', relations: 'unfriendly', rogueOnly: true, maxPercentNormal: 0.06, gainsPerThiefNormal: 0.0045, meterGain: 0.30 }),
  ...
  free_prisoners: Object.freeze({ id: 'free_prisoners', name: 'Free Prisoners', category: 'sabotage', relations: 'all', maxPercentNormal: 0.12, maxPercentWar: 0.17, gainsPerThiefNormal: 0.06, gainsPerThiefWar: 0.07, meterGain: 0.03 }),
...
export const AGE_116_DATA = Object.freeze({
  ...
  science: AGE_116_SCIENCE,
  spells: AGE_116_SPELLS,
  operations: AGE_116_OPERATIONS,
});
